...
/**
 * Factory to create {@link javax.json.stream.JsonParser} instances. If a factory
 * instance is configured with some configuration, that would be
 * used to configure the created parser instances.
 *
 * <p>
 * {@link javax.json.stream.JsonParser} can also be created using {@link Json Json}'s
