...
public class Json {
    ...
    */
     ...
     * @since 1.1
     */
    public static JsonPointer createPointer(String pointer) {
        return JsonProvider.provider().createPointer(pointer);
    }
     ...
     * @since 1.1
     */
    public static JsonPatch createPatch(JsonArray patch) {
        return JsonProvider.provider().createPatch(patch);
    }
}
